...
```
$ docker images |grep mintlayer
mintlayer/wallet-cli           0.1.3     57dcc4898a30   2 minutes ago   125MB
mintlayer/node-gui             0.1.3     a2ed3937e081   2 minutes ago   290MB
mintlayer/node-daemon          0.1.3     ad830bf576e3   3 minutes ago   119MB
```
