        ...
        let wallet_options = WalletCliArgs {
            network: Some(Network::Regtest(Box::new(RegtestOptions {
                ...
                run_options: wallet_cli_lib::config::CliArgs {
                    ...
                    start_staking: false,
                    node_rpc_address: Some(rpc_address.to_string()),
                    ...
                    connect_to_rpc_wallet_address: None,
                    connect_to_rpc_wallet_username: None,
                    connect_to_rpc_wallet_password: None,
                    connect_to_rpc_wallet_cookie_file: None,
                },
            }))),
            run_options: wallet_cli_lib::config::CliArgs {
                wallet_file: None,
