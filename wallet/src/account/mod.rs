...
impl<K: AccountKeyChains + Sync> Account<K> {
    ...
    pub fn reset_to_height<B: storage::BackendWithSendableTransactions>(
        &mut self,
    ...
    pub fn scan_new_blocks<B: storage::BackendWithSendableTransactions>(
        &mut self,
        db_tx: &mut StoreTxRw<B>,
        wallet_events: &impl WalletEvents,
        common_block_height: BlockHeight,
    ...
    fn update_conflicting_txs<B: storage::BackendWithSendableTransactions>(
        &mut self,
