...
use super::{UtxosDB, UtxosDBMut, UtxosStorageRead, UtxosStorageWrite, UtxosUndoStorageWrite};
...
impl<'a, S: UtxosStorageWrite> UtxosUndoStorageWrite for UtxosDBMut<'a, S> {
