...
class WalletOrderListOwnRpc(WalletOrdersListingTestBase):
    def run_test(self):
    ...
    async def async_test(self):
        ...
        async with WalletRpcController(node, self.config, self.log) as wallet:
            ...
            order1_expected_data = ExpectedRpcOwnOrderData(
                order1_id, order1_init_data, None, False, False)
            ...
            order2_expected_data = ExpectedRpcOwnOrderData(
                order2_id, order2_init_data, None, False, False)

            expected_own_orders = make_expected_rpc_own_order_datas(
            ...
            order3_expected_data = ExpectedRpcOwnOrderData(
                order3_id, order3_init_data, None, False, False)
            ...
            order3_expected_data.is_marked_as_frozen_in_wallet = True
            ...
            order3_expected_data.existing_data.is_frozen = True
            ...
            order3_expected_data.is_marked_as_concluded_in_wallet = True
            ...
            # Check the orders without generating a block, the orders should still exist and
            # the appropriate "is_marked_as_xxx_in_wallet" should be set.
            order2_expected_data.is_marked_as_concluded_in_wallet = True
            order1_expected_data.is_marked_as_concluded_in_wallet = True
            order1_expected_data.is_marked_as_frozen_in_wallet = True
