...
Every release has a tag and a release branch. Make sure you checkout the release you need. For example, if you need v0.4.0, you should first run the following to check out the release branch:
