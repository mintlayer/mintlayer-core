...
pub fn hash<D: Digest>(in_bytes: Vec<u8>, out_bytes: &mut Vec<u8>) {
    let mut hasher = D::new();
    hasher.update(in_bytes);
    *out_bytes = hasher.finalize().to_vec();
}
...
fn test_hash_blake2b() {
    ...
    hash::<Blake2b>((b"a").to_vec(), &mut buf_blake2);
...
fn test_hash_sha256() {
    ...
    hash::<Sha256>((b"mintlayer").to_vec(), &mut buf_sha2);
...
fn test_hash_sha3_512() {
    ...
    hash::<Sha3_512>((b"sha3-5").to_vec(), &mut buf_sha3);
