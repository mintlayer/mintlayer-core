...
pub fn hash<D: Digest>(in_bytes: Vec<u8>) -> Vec<u8> {
...
fn test_hash_blake2b() {
    ...
    let buf_blake2 = hash::<Blake2b>((b"a").to_vec());
...
fn test_hash_sha1() {
    ...
    let buf_sha1 = hash::<Sha1>((b"algo").to_vec());
...
fn test_hash_sha256() {
    ...
    let buf_sha2 = hash::<Sha256>((b"mintlayer").to_vec());
...
fn test_hash_sha3_512() {
    ...
    let buf_sha3 = hash::<Sha3_512>((b"sha3-5").to_vec());
...
fn test_ripemd160() {
    ...
    let buf_ripemd160 = hash::<Ripemd160>((b"ripemd160").to_vec());
...
fn let_us_play_bitcoin() {
    ...
    let tmp_sha = hash::<Sha256>((b"bitcointest").to_vec());
    let ans = hash::<Ripemd160>(tmp_sha);
