...
#[rustfmt::skip]
    ...
    fn from_fixedpoint_8_decimals() {
        ...
        assert_eq!(Amount::from_fixedpoint_str("21987654321.000000000", 8).unwrap(), Amount { atoms: 2198765432100000000 });
...
#[rustfmt::skip]
    ...
    fn from_fixedpoint_0_decimals() {
        ...
        assert_eq!(Amount::from_fixedpoint_str("21987654321.0", 0).unwrap(), Amount { atoms: 21987654321 });
        assert_eq!(Amount::from_fixedpoint_str("21987654321.00", 0).unwrap(), Amount { atoms: 21987654321 });
        assert_eq!(Amount::from_fixedpoint_str("21987654321.000", 0).unwrap(), Amount { atoms: 21987654321 });
        assert_eq!(Amount::from_fixedpoint_str("21987654321.0000", 0).unwrap(), Amount { atoms: 21987654321 });
        assert_eq!(Amount::from_fixedpoint_str("21987654321.00000", 0).unwrap(), Amount { atoms: 21987654321 });
        assert_eq!(Amount::from_fixedpoint_str("21987654321.000000", 0).unwrap(), Amount { atoms: 21987654321 });
        assert_eq!(Amount::from_fixedpoint_str("21987654321.0000000", 0).unwrap(), Amount { atoms: 21987654321 });
        assert_eq!(Amount::from_fixedpoint_str("21987654321.00000000", 0).unwrap(), Amount { atoms: 21987654321 });
        assert_eq!(Amount::from_fixedpoint_str("21987654321.000000000", 0).unwrap(), Amount { atoms: 21987654321 });
...
#[rustfmt::skip]
    ...
    fn from_fixedpoint_1_decimal() {
        ...
        assert_eq!(Amount::from_fixedpoint_str("21987654321.00", 1).unwrap(), Amount { atoms: 219876543210 });
        assert_eq!(Amount::from_fixedpoint_str("21987654321.000", 1).unwrap(), Amount { atoms: 219876543210 });
        assert_eq!(Amount::from_fixedpoint_str("21987654321.0000", 1).unwrap(), Amount { atoms: 219876543210 });
        assert_eq!(Amount::from_fixedpoint_str("21987654321.00000", 1).unwrap(), Amount { atoms: 219876543210 });
        assert_eq!(Amount::from_fixedpoint_str("21987654321.000000", 1).unwrap(), Amount { atoms: 219876543210 });
        assert_eq!(Amount::from_fixedpoint_str("21987654321.0000000", 1).unwrap(), Amount { atoms: 219876543210 });
        assert_eq!(Amount::from_fixedpoint_str("21987654321.00000000", 1).unwrap(), Amount { atoms: 219876543210 });
        assert_eq!(Amount::from_fixedpoint_str("21987654321.000000000", 1).unwrap(), Amount { atoms: 219876543210 });
