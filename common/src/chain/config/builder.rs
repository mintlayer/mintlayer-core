...
impl Builder {
    ...
    pub fn new(chain_type: ChainType) -> Self {
        ...
        Self {
            ...
            fungible_token_min_issuance_fee: super::FUNGIBLE_TOKEN_MIN_ISSUANCE_FEE,
            nft_min_issuance_fee: super::NFT_MIN_ISSUANCE_FEE,
    ...
    pub fn build(self) -> ChainConfig {
        let Self {
            ...
            fungible_token_min_issuance_fee,
            nft_min_issuance_fee,
