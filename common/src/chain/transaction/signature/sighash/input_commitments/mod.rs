...
pub enum SighashInputCommitment<'a> {
    ...
    /// For ConcludeOrder we want to commit to the initial and final "ask" balances, as well as
    /// the final give balance. Committing to the initial "give" balance is not necessary, but
