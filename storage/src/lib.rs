...
trait Storage {
    ...
    fn duplicates_allowed<I: ?Sized>(db_index: I) -> bool;
    ...
    fn set<I: ?Sized, K: AsRef<[u8]>, V: AsRef<[u8]>>(
        &mut self,
        db_index: I,
        key: K,
        val: V,
    ...
    fn get_multiple<I: ?Sized, K: AsRef<[u8]>>(
        &mut self,
        db_index: I,
        key: K,
    ...
    fn get_all_unique<I: ?Sized, K: AsRef<[u8]>>(
        &mut self,
        db_index: I,
        key: K,
    ...
    fn erase_one<I: ?Sized, K: AsRef<[u8]>, V: AsRef<[u8]>>(
        &mut self,
        db_index: I,
        key: K,
        val: V,
    ...
    fn erase<I: ?Sized, K: AsRef<[u8]>>(db_index: I, key: K) -> Result<(), DBError>;
    ...
    fn clear_db<I: ?Sized>(&mut self, db_index: I) -> Result<(), DBError>;
