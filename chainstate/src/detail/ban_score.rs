...
impl BanScore for orders_accounting::Error {
    fn ban_score(&self) -> u32 {
        ...
        match self {
            ...
            Error::InvariantOrderDataExistForWithdrawUndo(_) => 100,
            Error::InvariantOrderAskBalanceExistForWithdrawUndo(_) => 100,
            Error::InvariantOrderGiveBalanceExistForWithdrawUndo(_) => 100,
            Error::FillOrderChangeLeft(_) => 100,
            Error::CurrencyMismatch => 100,
            Error::OrderOverflow(_) => 100,
            Error::AttemptedWithdrawNonexistingOrderData(_) => 100,
            Error::AttemptedWithdrawNonexistingAskBalance(_) => 100,
            Error::AttemptedWithdrawNonexistingGiveBalance(_) => 100,
            Error::ViewFail => 0,
