...
use common::{
    chain::{
        ...
        AccountNonce, AccountOutPoint, AccountSpending, ConsensusUpgrade, Destination, GenBlock,
        NetUpgradeVersion, NetUpgrades, OutPointSourceId, PoSChainConfigBuilder, PoolId, TxInput,
