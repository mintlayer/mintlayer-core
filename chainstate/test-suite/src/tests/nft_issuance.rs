...
use common::chain::{
    ...
    Block, ChainstateUpgrade, DataDepositFeeVersion, Destination, HtlcActivated, OrdersActivated,
    OutPointSourceId, RewardDistributionVersion, TokenIssuanceVersion, TokensFeeVersion, TxInput,
    TxOutput,
};
