...
use chainstate_test_framework::{
    create_chain_config_with_staking_pool_impl, empty_witness, PoSBlockBuilder, TestFramework,
    TransactionBuilder,
};
use common::{
    chain::{
...
fn pool_decommissioning(#[case] seed: Seed) {
    ...
    let chain_config = create_chain_config_with_staking_pool_impl(
        &mut rng,
...
fn order_fill(#[case] seed: Seed, #[case] orders_version: OrdersVersion) {
    ...
    let coins_left = tf.coin_amount_from_outpoint(&coins_outpoint);
